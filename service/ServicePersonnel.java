...
import bookstore.Interface.InterfacePersonnel;
...
Myconnection cnx;
    ...
    try {
         String req3= "update personnel set poste=? ,cin=?, nom=?, prenom=?, adresse=?, email=?, username=?, password=?, type=?  where cin=? ";
